...
@TeleOp(name = "ezdubs", group = "Iterative OpMode")
public class ezdubs extends OpMode
{
    ...
    public void loop() {
        ...
        robot.lr.setPower(y - x + rx);
        robot.rf.setPower(y - x - rx);
        robot.rr.setPower(y + x - rx);

          if(controller.left_trigger!=0) robot.intake.setPower(0.7);
          if(controller.right_trigger!=0) robot.intake.setPower(-0.7);
          if(controller.left_trigger==0) robot.intake.setPower(0.0);
          if(controller.right_trigger==0) robot.intake.setPower(0.0);
        if(controller2.right_trigger!=0) robot.lift.setPower(0.7);
        if(controller2.left_trigger!=0) robot.lift.setPower(-0.7);
        if(controller2.right_trigger==0) robot.lift.setPower(0);
        if(controller2.left_trigger==0) robot.lift.setPower(0);
        //test the four lines for dropper below
        //if(controller.rightBumper()) robot.dropper.setPosition(0.33);
        //if(controller.leftBumper()) robot.dropper.setPosition(1);
        //if (controller.rightBumper()==false) robot.dropper.setPosition(0);
        //if (controller.leftBumper()==false) robot.dropper.setPosition(0);
